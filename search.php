<?php
    ...
    if(strlen($_POST['query']) == 0){
        ...
        if(count($names) ==2)
            ...
            $users = queryFunc("SELECT first_name, last_name,profile_pic from users where first_name like '$names[0]%' AND last_name like '$names[1]%'  limit 5" );  
        else
            ...
            $users = queryFunc("SELECT first_name, last_name,profile_pic from users where first_name like '$names[0]%' OR last_name like '$names[0]%' limit 5" );
